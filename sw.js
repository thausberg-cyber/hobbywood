const CACHE='look-talk-n-build-v0-9-20a';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./favicon.png','./tree-ring-bg.jpg'];
